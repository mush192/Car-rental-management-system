...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best Rental <span>CarForYou</span></h2>
      <p>Book Car Rental Today & Save with The World's Leading Car Hire Service.You benefit from unlimited free mileage, nice cars and a top service. Enjoy Your ride! Discover Your desired destination with the rental car You prefer.</p>
    </div>
    <div class="row"> 
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-calendar" aria-hidden="true"></i>24*7</h2>
            <p>services</p>
          </div>
        </div>
      </div>
